    ...
    class RequestHandler(BaseRequestHandler):
        ...
        def handle(self):
            ...
            # Packet is from Jan to the Airforce
                ...
                sequenceNumber = random.randint(10000,
                                                99999)  # First time talking to Jan, create new sequence number
                ...
                responsePacket = helper.CreateTCPPacket(sourceID, destinationID, acknowledgementNumber, sequenceNumber,
